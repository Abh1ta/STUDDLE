...
const PaginaMateriale = () => {
  ...
  const primaZiLuni =
    (new Date(anCurent, lunaCurentaIndex, 1).getDay() + 6) % 7;
  ...
  const renderZileCalendar = () => {
    ...
    for (let zi = 1; zi <= zileInLuna; zi++) {
      ...
      const dataFormatata =
        `${anCurent}-${String(lunaCurentaIndex + 1).padStart(2, '0')}-${String(zi).padStart(2, '0')}`;

      const examenInZiuaAsta =
        examene.find(ex => ex.data === dataFormatata);
      ...
      elementeZile.push(
        <span
          ...
          style={
            examenInZiuaAsta
              ? { borderColor: examenInZiuaAsta.culoare }
              : {}
          }
        >
          {zi}
      ...
      <main className="main-content">
        ...
        <div className="container-materii-border">
          <div className="grid-materii">
            ...
            {materii.map((m) => (
              <div key={m.id} className="card-materie">
        ...
        <div className="container-materii-border">
          <div className="grid-materii">
            ...
            {teme.map((t) => (
              <div key={t.id} className="caiet-card">
